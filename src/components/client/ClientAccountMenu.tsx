...
export function ClientAccountMenu({ name, email, clientName, avatarUrl }: { name: string; email: string; clientName: string; avatarUrl?: string | null }) {
