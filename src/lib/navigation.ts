...
export const navigationItems: NavigationItem[] = [
  ...
  { label: "Clientes", description: "Histórico e relacionamentos", href: "/clientes", icon: "clients", rolesAllowed: ["admin", "manager"], group: "operational" },
  { label: "Drive", description: "Arquivos internos", href: "/drive", icon: "drive", rolesAllowed: ["admin", "manager"], group: "operational" },
  { label: "CRM", description: "Leads e ativações", href: "/crm", icon: "crm", rolesAllowed: ["admin", "manager"], group: "admin" },
  { label: "Dashboard de Dados", description: "Indicadores da operação", href: "/dashboard", icon: "dashboard", rolesAllowed: ["admin", "manager"], group: "admin" },
